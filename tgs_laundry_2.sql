...
--
-- Host: localhost
-- Waktu pembuatan: 17 Agu 2021 pada 16.14
-- Versi server: 5.6.38
-- Versi PHP: 7.4.3
...
('OTL0001', 'Outlet 1', 'Jl. Satu no.1', '08563621676'),
...
('CST0004', 'Cahyo', 'Jl. Sukabumi', '086142222454', 'OTL0004', 'reguler'),
...
--
ALTER TABLE `tb_pakaian`
  MODIFY `id_pakaian` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
